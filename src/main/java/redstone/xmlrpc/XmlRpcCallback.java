...
public interface XmlRpcCallback {
    ...
    /**
     * Called by the XmlRpcClient when a fault response was received from the
     * server.
     *
     ...
     * This only includes exceptions occurring locally. Remote exceptions are
     * transported as XML-RPC faults and are reported through the onFault()
     * callback.
     *
     * @param exception The local exception which can be the result of network
     * problems, or problems with the XML payload and serialization.
     */
