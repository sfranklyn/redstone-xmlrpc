 ...
 * know the name of the method for which values are supplied.</p>
 *
 * <p>
...
public abstract class XmlRpcParser extends DefaultHandler {
     ...
     *
     * @param obj The parsed value object. Can be String, Integer, Double,
     ...
     *
     * @throws XmlRpcException If anything went wrong during the whole parsing
     * phase
     */
     ...
     * the trim() method when the character data is consumed.</p>
     *
