...
/**
 * <p>
 * An Array represents an XML-RPC array in its Java form. Essentially, it's just
 * a java.util.ArrayList with utility methods for extracting members of any of
 * the data types supported by the XML-RPC library. The class does not introduce
 * any new field members which makes it no more expensive than a regular
 * ArrayList.</p>
 *
 * <p>
 * To extract nested values from the list, use the new simplified accessors
...
public class XmlRpcArray extends ArrayList {
     ...
     * @return 
     * @throws ClassCastException if the value at the given index is not a
     * String.
     */
     ...
     * @param index The index into the array to extract the value from.
     * @return 
     * @throws ClassCastException if the value at the given index is not an
     * Integer.
     */
    ...
    /**
     * Returns the byte[] with at the given index in the Array, as an input
     * stream (currently, a java.io.ByteArrayInputStream).
     *
